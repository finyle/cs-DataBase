...
```
Trie::insert, remove; insertNode, removeNode
```
...
#### 优化： 高效的页面替换算法， 并行io处理
```
BufferPoolManager:: NewPage, UnpinPage, FlushPage, FetchPage
ClockReplacer:: Pin Unpin Size Victim
LruReplacer:: RecordAccess, SetEvictable, Evice, Size, Remove
```
...
```
Binder::ParseAndSave
Catalog::CreateTable, CreateIndex
```
